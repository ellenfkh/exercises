...
int main(int argc, char* argv[]) {
  ...
  for(int i = 0; i < 5; ++i){
    contractFieldFieldTensorKokkos<Kokkos::OpenMP, omp_input_view_t, omp_output_view_t, omp_input_host_t, omp_output_host_t> 
      (omp_hostOut, omp_hostLeft, omp_hostRight, omp_kokkosOut, omp_kokkosLeft,
       omp_kokkosRight, &elapsedTime_kokkos_noCopy);
  }
  ...
  //Warmpup
  contractFieldFieldTensorKokkos<Kokkos::Cuda, cuda_input_view_t, cuda_output_view_t, cuda_input_host_t, cuda_output_host_t> 
  ...
  for(int i = 0; i < 5; ++i){
    contractFieldFieldTensorKokkos<Kokkos::Cuda, cuda_input_view_t, cuda_output_view_t, cuda_input_host_t, cuda_output_host_t> 
      (cuda_hostOut, cuda_hostLeft, cuda_hostRight, cuda_kokkosOut,
       cuda_kokkosLeft, cuda_kokkosRight, &elapsedTime_kokkos_noCopyCuda);
  }
